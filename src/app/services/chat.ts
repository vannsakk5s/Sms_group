...
export class ChatService {
  ...
  private authService = inject(AuthService);
  private socket: Socket;
  private apiUrl = 'https://technical-officially-chelsea-workplace.trycloudflare.com/api/messages';
  messages = signal<any[]>([]);
  ...
  //   const url = `https://technical-officially-chelsea-workplace.trycloudflare.com/api/chat/history/${room}&since=${loginTime}`;
  ...
  loadMessages(room: string) {
    ...
    const url = `https://technical-officially-chelsea-workplace.trycloudflare.com/api/chat/history/${room}?since=${sinceParam}`;
