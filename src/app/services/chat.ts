...
//     this.socket = io('https://september-document-cheap-cloud.trycloudflare.com', {
...
export class ChatService {
  ...
  private authService = inject(AuthService);
  private socket: Socket;
  private apiUrl = 'https://september-document-cheap-cloud.trycloudflare.com/api/messages';
  messages = signal<any[]>([]);
  ...
  //   const url = `https://september-document-cheap-cloud.trycloudflare.com/api/chat/history/${room}&since=${loginTime}`;
  ...
  loadMessages(room: string) {
    ...
    const url = `https://september-document-cheap-cloud.trycloudflare.com/api/chat/history/${room}?since=${sinceParam}`;
