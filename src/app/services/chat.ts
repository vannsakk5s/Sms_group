...
export class ChatService {
  ...
  private authService = inject(AuthService);
  private socket: Socket;
  private apiUrl = 'https://childrens-selective-arthritis-vincent.trycloudflare.com/api/messages';
  messages = signal<any[]>([]);
  ...
  //   const url = `https://childrens-selective-arthritis-vincent.trycloudflare.com/api/chat/history/${room}&since=${loginTime}`;
  ...
  loadMessages(room: string) {
    ...
    const url = `https://childrens-selective-arthritis-vincent.trycloudflare.com/api/chat/history/${room}?since=${sinceParam}`;
