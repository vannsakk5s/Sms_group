...
export class ChatService {
  ...
  private authService = inject(AuthService);
  private socket: Socket;
  private apiUrl = 'https://wet-tumor-closer-dried.trycloudflare.com/api/messages';
  messages = signal<any[]>([]);
  ...
  //   const url = `https://wet-tumor-closer-dried.trycloudflare.com/api/chat/history/${room}&since=${loginTime}`;
  ...
  loadMessages(room: string) {
    ...
    const url = `https://wet-tumor-closer-dried.trycloudflare.com/api/chat/history/${room}?since=${sinceParam}`;
